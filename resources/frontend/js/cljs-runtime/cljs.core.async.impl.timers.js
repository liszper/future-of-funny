...
var i_42555 = (0);
while(true){
if((i_42555 < arr.length)){
(arr[i_42555] = null);

var G__42556 = (i_42555 + (1));
i_42555 = G__42556;
continue;
} else {
}
...
var i_42576 = (self__.level + (1));
while(true){
if((i_42576 <= (new_level + (1)))){
(update[i_42576] = self__.header);

var G__42577 = (i_42576 + (1));
i_42576 = G__42577;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42582 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42582[i]));
} else {
x__$2.forward.push((((i < links_42582.length))?(links_42582[i]):null));
}

if((i < links_42582.length)){
(links_42582[i] = x__$2);
} else {
links_42582.push(x__$2);
}
...
var i_42584 = (0);
while(true){
if((i_42584 <= self__.level)){
var links_42589 = (update[i_42584]).forward;
if((x__$1 === (((i_42584 < links_42589.length))?(links_42589[i_42584]):null))){
(links_42589[i_42584] = (x__$1.forward[i_42584]));

var G__42590 = (i_42584 + (1));
i_42584 = G__42590;
continue;
} else {
var G__42591 = (i_42584 + (1));
i_42584 = G__42591;
continue;
}
} else {
...
var G__42593 = nx;
var G__42594 = (level__$1 - (1));
x = G__42593;
level__$1 = G__42594;
continue;
} else {
var G__42595 = x;
var G__42596 = (level__$1 - (1));
x = G__42595;
level__$1 = G__42596;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__42600 = nx;
var G__42601 = (level__$1 - (1));
x = G__42600;
level__$1 = G__42601;
continue;
} else {
var G__42602 = x;
var G__42603 = (level__$1 - (1));
x = G__42602;
level__$1 = G__42603;
continue;
}
