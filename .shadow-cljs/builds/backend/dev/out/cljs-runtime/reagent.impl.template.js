...
var G__31692 = o;
reagent.impl.template.goog$module$goog$object.set(G__31692,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__31702 = o;
reagent.impl.template.goog$module$goog$object.set(G__31702,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__31706 = props;
var G__31706__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31706,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31706);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31706__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31707 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31707,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31707;
}
})(),id_class);
...
var G__31708 = (cljs.core.count(argv) - first_child);
switch (G__31708) {
case (0):
...
var vec__31714 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31714,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31714,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31714,(2),null);
...
var temp__5808__auto___31825 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___31825 == null)){
} else {
var key_31826 = temp__5808__auto___31825;
...
var temp__5808__auto___31827 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___31827 == null)){
} else {
var key_31828 = temp__5808__auto___31827;
...
var temp__5808__auto___31830 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___31830 == null)){
} else {
var key_31831 = temp__5808__auto___31830;
(jsprops.key = key_31831);
}
...
var temp__5808__auto___31832 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___31832 == null)){
} else {
var key_31833 = temp__5808__auto___31832;
(jsprops.key = key_31833);
}
...
var temp__5808__auto___31834 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___31834 == null)){
} else {
var key_31835 = temp__5808__auto___31834;
(jsprops.key = key_31835);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31760_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31760_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31767 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31767,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31767,(1),null);
...
break;
default:
var G__31837 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__31838 = compiler;
v = G__31837;
compiler = G__31838;
continue;
...
var G__31775 = tag;
var G__31775__$1 = (((G__31775 instanceof cljs.core.Keyword))?G__31775.fqn:null);
switch (G__31775__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31793 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31793 = (function (opts,id,fn_to_element,parse_fn,meta31794){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31793.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31795,meta31794__$1){
var self__ = this;
var _31795__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31793(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta31794__$1));
}));

(reagent.impl.template.t_reagent$impl$template31793.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31795){
var self__ = this;
var _31795__$1 = this;
return self__.meta31794;
}));

(reagent.impl.template.t_reagent$impl$template31793.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31793.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31793.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template31793.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31793.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31793.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta31794","meta31794",-1867014731,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31793.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31793.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31793");

(reagent.impl.template.t_reagent$impl$template31793.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template31793");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31793.
 */
reagent.impl.template.__GT_t_reagent$impl$template31793 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31793(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31794){
return (new reagent.impl.template.t_reagent$impl$template31793(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31794));
});

}

return (new reagent.impl.template.t_reagent$impl$template31793(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
