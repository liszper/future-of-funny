...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42640 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42640(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_42641 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_42641(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_42642 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_42642(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_42647 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_42647(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_42648 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_42648(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_42651 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_42651(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__42630,callback){
var map__42631 = p__42630;
var map__42631__$1 = cljs.core.__destructure_map(map__42631);
var input = map__42631__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42631__$1,new cljs.core.Keyword(null,"code","code",1586293142));
