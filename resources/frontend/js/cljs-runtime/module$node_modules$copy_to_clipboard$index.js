...
options?options.message:"Copy to clipboard: #{key}, Enter");window.prompt(message,text)}}finally{selection&&("function"==typeof selection.removeRange?selection.removeRange(range):selection.removeAllRanges()),mark&&document.body.removeChild(mark),reselectPrevious()}return success}}
//# sourceMappingURL=module$node_modules$copy_to_clipboard$index.js.map
