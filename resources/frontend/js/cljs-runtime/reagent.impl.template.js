...
var G__48530 = o;
reagent.impl.template.goog$module$goog$object.set(G__48530,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__48598__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48598 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48599__i = 0, G__48599__a = new Array(arguments.length -  0);
while (G__48599__i < G__48599__a.length) {G__48599__a[G__48599__i] = arguments[G__48599__i + 0]; ++G__48599__i;}
  args = new cljs.core.IndexedSeq(G__48599__a,0,null);
} 
return G__48598__delegate.call(this,args);};
G__48598.cljs$lang$maxFixedArity = 0;
G__48598.cljs$lang$applyTo = (function (arglist__48600){
var args = cljs.core.seq(arglist__48600);
return G__48598__delegate(args);
});
...
var G__48537 = o;
reagent.impl.template.goog$module$goog$object.set(G__48537,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__48601__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48601 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__48603__i < G__48603__a.length) {G__48603__a[G__48603__i] = arguments[G__48603__i + 0]; ++G__48603__i;}
  args = new cljs.core.IndexedSeq(G__48603__a,0,null);
} 
return G__48601__delegate.call(this,args);};
G__48601.cljs$lang$maxFixedArity = 0;
G__48601.cljs$lang$applyTo = (function (arglist__48605){
var args = cljs.core.seq(arglist__48605);
return G__48601__delegate(args);
});
G__48601.cljs$core$IFn$_invoke$arity$variadic = G__48601__delegate;
return G__48601;
})()
;
} else {
...
var G__48543 = props;
var G__48543__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48543,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48543);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48543__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__48550 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48550,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48550;
}
})(),id_class);
...
var G__48557 = (cljs.core.count(argv) - first_child);
switch (G__48557) {
case (0):
...
var vec__48564 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48564,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48564,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48564,(2),null);
...
var temp__5808__auto___48615 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___48615 == null)){
} else {
var key_48616 = temp__5808__auto___48615;
(jsprops.key = key_48616);
}
...
var temp__5808__auto___48618 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___48618 == null)){
} else {
var key_48619 = temp__5808__auto___48618;
(jsprops.key = key_48619);
}
...
var temp__5808__auto___48627 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___48627 == null)){
} else {
var key_48628 = temp__5808__auto___48627;
(jsprops.key = key_48628);
}
...
var temp__5808__auto___48632 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___48632 == null)){
} else {
var key_48633 = temp__5808__auto___48632;
(jsprops.key = key_48633);
}
...
var temp__5808__auto___48634 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___48634 == null)){
} else {
var key_48635 = temp__5808__auto___48634;
(jsprops.key = key_48635);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48588_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__48588_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__48589 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48589,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48589,(1),null);
...
break;
default:
var G__48644 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__48645 = compiler;
v = G__48644;
compiler = G__48645;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template48595 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template48595 = (function (opts,id,fn_to_element,parse_fn,meta48596){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta48596 = meta48596;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template48595.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48597,meta48596__$1){
var self__ = this;
var _48597__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template48595(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta48596__$1));
}));

(reagent.impl.template.t_reagent$impl$template48595.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48597){
var self__ = this;
var _48597__$1 = this;
return self__.meta48596;
}));

(reagent.impl.template.t_reagent$impl$template48595.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template48595.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template48595.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template48595.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template48595.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template48595.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta48596","meta48596",1607189049,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template48595.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template48595.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template48595");

(reagent.impl.template.t_reagent$impl$template48595.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template48595");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template48595.
 */
reagent.impl.template.__GT_t_reagent$impl$template48595 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template48595(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48596){
return (new reagent.impl.template.t_reagent$impl$template48595(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48596));
});

}

return (new reagent.impl.template.t_reagent$impl$template48595(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
